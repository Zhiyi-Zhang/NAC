...
{
  RsaKeyParams params;
  auto sKey = Rsa::generateKey(params);
  auto pKey = Rsa::deriveEncryptKey(sKey);

  auto cipherText = Rsa::encrypt(pKey.data(), pKey.size(),
                                 plainText, sizeof(plainText));
  auto decrypted = Rsa::decrypt(sKey.data(), sKey.size(),
